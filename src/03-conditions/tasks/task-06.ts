...
if (isCritical) {
  ...
  destination = age >= 60 ? "Priority Queue" : "Regular Queue";
} else {
  destination = hasInsurance ? "Insurance Registration Counter" : "General Registration Counter";
}

console.log(`${patientName} is assigned to: ${destination}`);